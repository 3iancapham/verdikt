...
export default function ProductPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      >
        <button onClick={() => router.back()} className="absolute right-4 top-4 z-10 bg-white rounded-full p-2">
          <X size={24} />
        </button>
        ...
        <button
          ...
          className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10 bg-white/80 rounded-full p-2"
        ...
        <button
          ...
          className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 bg-white/80 rounded-full p-2"
      ...
      {/* Product Details */}
      <div className="relative flex-1 bg-white px-6 pt-6">
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-gray-300 rounded-full" />

        <div className="space-y-6 pb-6">
          <h1 className="text-2xl font-semibold">Nike Air Force 1</h1>

          <div className="text-xl">
            $115.00 <span className="text-gray-500 text-base">+ Delivery & Tax</span>
          </div>

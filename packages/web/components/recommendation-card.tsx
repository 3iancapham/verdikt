    ...
    >
      ...
      <div className="p-3 space-y-1">
        <div className="flex justify-between items-start">
          <h3 className="font-medium text-gray-900 truncate flex-1 mr-2">{title}</h3>
          <Button
            size="sm"
            variant={isFollowed ? "outline" : "default"}
            className={`rounded-full h-7 px-2 min-w-[70px] gap-1 ${
              isFollowed
          ...
          >
            {isFollowed ? (
              ...
              <>
                <Plus size={14} />
                <span className="text-xs pr-1">Follow</span>
              </>
            )}
          </Button>
        </div>

  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="p-4 border-b">
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-4">
              <div className="flex items-center">
                <span className="font-medium text-sm sm:text-base">{profile.following}</span>
                <span className="text-gray-500 text-xs sm:text-sm ml-1">Following</span>
              </div>
              <div className="flex items-center">
                <span className="font-medium text-sm sm:text-base">{profile.followers}</span>
                <span className="text-gray-500 text-xs sm:text-sm ml-1">Followers</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-4">
          <div className="bg-gray-50 rounded-lg p-2 sm:p-3 text-center">
            ...
            <div className="text-base sm:text-lg font-bold">{profile.reviewCount}</div>
            <div className="text-[10px] sm:text-xs text-gray-500">Reviews</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-2 sm:p-3 text-center">
            <div className="flex justify-center mb-1 text-indigo-500">
              <Users size={16} className="sm:w-5 sm:h-5" />
            </div>
            <div className="text-base sm:text-lg font-bold">{profile.cloutScore}</div>
            <div className="text-[10px] sm:text-xs text-gray-500">Clout Score</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-2 sm:p-3 text-center">
            <div className="flex justify-center mb-1 text-indigo-500">
            ...
            <button
              ...
              className="text-base sm:text-lg font-bold hover:text-indigo-500 transition-colors"
            >
        ...
        {/* Topics */}
        <div>
          <h3 className="text-xs sm:text-sm font-medium text-gray-500 mb-2">Following Topics</h3>
      ...
      <Tabs defaultValue="reviews" className="flex-1 flex flex-col">
        <TabsList className="grid grid-cols-3 border-b rounded-none bg-white h-10 sm:h-12">
          <TabsTrigger
            value="reviews"
            className="text-sm sm:text-base data-[state=active]:border-b-2 data-[state=active]:border-indigo-500 data-[state=active]:shadow-none rounded-none"

...
import { Camera, ImageIcon, Lock, Unlock, Plus, X, ChevronDown, Search } from "lucide-react"
...
interface CreateVerdiktFormProps {
  onSubmit: (data: any) => void
  onCancel: () => void
}

export function CreateVerdiktForm({ onSubmit, onCancel }: CreateVerdiktFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex-1 p-4 space-y-0 overflow-y-auto pb-24">
      {/* Category & Product */}
      <div className="space-y-4 py-4 border-b border-gray-100">
        {/* Category Selection */}
        <div className="flex justify-between items-center">
          <span className="text-gray-700 text-base font-medium">Category</span>
          <Popover open={categoryOpen} onOpenChange={setCategoryOpen}>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className={`w-1/2 justify-between text-base ${!selectedCategory ? "text-gray-400" : ""}`}
              >
        ...
        {/* Product Tag */}
        <div className="flex justify-between items-center">
          <span className="text-gray-700 text-base font-medium">Tag Product</span>
          <div className="w-1/2">
            {selectedProduct ? (
              <div className="flex items-center justify-between bg-indigo-50 rounded-md p-2">
                <div className="flex items-center">
                  ...
                  <span className="text-base font-medium truncate max-w-[120px]">{selectedProduct.name}</span>
                </div>
              ...
              <Popover open={productSearchOpen} onOpenChange={setProductSearchOpen}>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-between text-gray-400 text-base">
                    <div className="flex items-center">
      ...
      <div className="flex justify-between items-center py-4 border-b border-gray-100">
        <span className="text-gray-700 text-base font-medium">Rating</span>
      ...
      {/* Review Content Section - Now takes remaining space */}
      <div className="flex-1 flex flex-col min-h-[calc(100vh-450px)]">
        <Textarea
          placeholder="Share your verdikt...."
          value={content}
          onChange={(e) => setContent(e.target.value)}
          className="flex-1 text-lg border-none resize-none focus:ring-0 min-h-[200px] p-0"
        />
